...
static struct max8998_adc_table_data temper_table[] =  {
	...
	{  1711,  -90 },
	{  1731,  -100}, // 0
#elif defined(CONFIG_PHONE_ARIES_CTC)
	{  264,  650 },
	{  275,  640 },
	{  286,  630 },
	{  293,  620 },
...
static struct gpio_init_data aries_init_gpios[] = {
    ...
    // GPB -----------------------------
	{
		.num	= S5PV210_GPB(0), // GPIO_QSC_RESET_N
		.cfg	= S3C_GPIO_OUTPUT,
 .val = S3C_GPIO_SETPIN_ONE, 
		.pud	= S3C_GPIO_PULL_NONE,
		.drv	= S3C_GPIO_DRVSTR_1X,
	}, {
		.num	= S5PV210_GPB(1), // GPIO_QSC_PHONE_ON
		.cfg	= S3C_GPIO_OUTPUT,
...
.num =S5PV210_GPG3(0), 
 ...
 .cfg = S3C_GPIO_INPUT,   
	...
	// GPH1 ----------------------------
	{
		...
		.drv	= S3C_GPIO_DRVSTR_1X,
#else
		.num	= S5PV210_GPH1(0),//GPIO_QSC_ACTIVE
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
 .pud = S3C_GPIO_PULL_NONE,
		.drv	= S3C_GPIO_DRVSTR_1X,
...
void s3c_config_gpio_table(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(aries_init_gpios); i++) {
		...
		if (0)//(system_rev <= 0x07 && gpio == S5PV210_GPJ3(3)) 
		{
...
#if defined (CONFIG_SAMSUNG_CAPTIVATE) || defined(CONFIG_PHONE_ARIES_CTC)
	&s3c_device_i2c13,
#endif
...
#if defined(CONFIG_PHONE_ARIES_CDMA) //|| defined(CONFIG_PHONE_ARIES_CTC)
	&sec_device_dpram,
#endif
