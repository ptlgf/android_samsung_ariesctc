...
#define GPIO_AP_RXD					S5PV210_GPA1(0)//ctc
#define GPIO_AP_RXD_AF				0x2 // UART_2_RXD

#define GPIO_AP_TXD					S5PV210_GPA1(1)//ctc
#define GPIO_AP_TXD_AF				0x2 // UART_2_TXD

#define GPIO_PHONE_ON				S5PV210_GPB(1)//ctc
#define GPIO_PHONE_ON_AF			0x1

#define GPIO_PHONE_RST_N					S5PV210_GPB(0)//ctc
#define GPIO_PHONE_RST_N_AF				0x1

#define GPIO_PDA_ACTIVE				S5PV210_MP03(3)//ctc
#define GPIO_PDA_ACTIVE_AF			0x1

#define GPIO_PHONE_ACTIVE			S5PV210_GPH1(0)//ctc
#define GPIO_PHONE_ACTIVE_AF		0xff	

#define GPIO_ONEDRAM_INT_N		S5PV210_GPJ4(3) //ctc
#define GPIO_ONEDRAM_INT_N_AF	0xff

#define IRQ_ONEDRAM_INT_N		IRQ_MSM //ctc
#define IRQ_PHONE_ACTIVE		IRQ_EINT8 //ctc
